# Baseline 1: 2D ECGResNet (randomly initialized), Data Type 1

**Paper section:** 3.3.2 (see `../../../draft.pdf`)

Non-pretrained variant isolating the effect of ImageNet transfer learning, Data Type 1.

## Contents

- `main_2d_resnet_typ1_pretrained_False.ipynb`

- `EXPERIMENT_2d_resnet_typ1_ECGresnet_pretrain_FALSE_randomseed/` — per-seed logs (`*_seed40.txt` … `*_seed44.txt`), learning curves, confusion matrix, ROC/PR plots, and a `*_multiseed_summary.csv`

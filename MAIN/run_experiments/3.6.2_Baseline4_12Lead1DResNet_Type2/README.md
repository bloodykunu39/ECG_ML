...
- `main_1d_resnet_typ2_selfeeg.ipynb`

- `EXPERIMENT_resnet_1d_selfeeg_typ2_randomseed/` — per-seed logs (`*_seed40.txt` … `*_seed44.txt`), learning curves, confusion matrix, ROC/PR plots, and a `*_multiseed_summary.csv`

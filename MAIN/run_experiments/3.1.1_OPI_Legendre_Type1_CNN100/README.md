# OPI (Legendre) benchmarking, CNN, 100x100, Data Type 1

**Paper section:** 3.1.1 (see `../../../draft.pdf`)

SmallCNN trained on Legendre-polynomial OPI-encoded 100x100 images, clean single-diagnosis dataset (Type 1).

## Contents

- `main_2d_leg_typ1.ipynb`

- `EXPERIMENT_2d_leg_typ1_smallcnn_randomseed/` — per-seed logs (`*_seed40.txt` … `*_seed44.txt`), learning curves, confusion matrix, ROC/PR plots, and a `*_multiseed_summary.csv`

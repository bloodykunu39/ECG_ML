# Baseline 5: Single-lead raw ECG, SelfEEG ResNet1D, Data Type 2

**Paper section:** 3.7.2 (see `../../../draft.pdf`)

SelfEEG ResNet1D trained on Lead 1 only (1x5000), Data Type 2.

## Contents

- `main_1d_resnet_typ2_selfeeg_singlelead1.ipynb`

- `EXPERIMENT_resnet_1d_selfeeg_typ2_singlelead1_randomseed/` — per-seed logs (`*_seed40.txt` … `*_seed44.txt`), learning curves, confusion matrix, ROC/PR plots, and a `*_multiseed_summary.csv`

# Baseline 2: Vanilla Transformer, Data Type 2

**Paper section:** 3.4.2 (see `../../../draft.pdf`)

VanillaTransformerECG trained on raw 12-lead ECG signals, Data Type 2.

## Contents

- `main_1_transformer_typ2.ipynb`

- `EXPERIMENT_2d_transformer_typ2_VanillaTransformerECG_randomseed/` — per-seed logs (`*_seed40.txt` … `*_seed44.txt`), learning curves, confusion matrix, ROC/PR plots, and a `*_multiseed_summary.csv`

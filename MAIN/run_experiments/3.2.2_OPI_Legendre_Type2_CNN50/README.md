# OPI (Legendre) benchmarking, CNN, reduced 50x50, Data Type 2

**Paper section:** 3.2.2 (see `../../../draft.pdf`)

Robustness check: SmallCNN on 50x50 Legendre OPI images, Data Type 2.

## Contents

- `main_2d_leg_on_50_typ2.ipynb`

- `EXPERIMENT_2d_leg_50_typ2_smallcnn_randomseed/` — per-seed logs (`*_seed40.txt` … `*_seed44.txt`), learning curves, confusion matrix, ROC/PR plots, and a `*_multiseed_summary.csv`

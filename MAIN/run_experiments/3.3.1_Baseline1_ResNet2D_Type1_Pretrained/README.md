...
Standard 2D image-based ResNet baseline on the raw lead-by-time ECG matrix (12x5000), pretrained weights, Data Type 1.

## Contents

- `main_2d_resnet_typ1.ipynb`

- `EXPERIMENT_2d_resnet_typ1_ECGresnet_randomseed/` — per-seed logs (`*_seed40.txt` … `*_seed44.txt`), learning curves, confusion matrix, ROC/PR plots, and a `*_multiseed_summary.csv`

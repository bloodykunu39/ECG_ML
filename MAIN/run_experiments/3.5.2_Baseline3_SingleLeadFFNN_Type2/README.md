# Baseline 3: Single-lead FFNN (Lead 1), Data Type 2

**Paper section:** 3.5.2 (see `../../../draft.pdf`)

Feed-forward neural network on raw Lead-1 signal only, Data Type 2.

## Contents

- `main_1_ffnn_singlelead_typ2.ipynb`

- `EXPERIMENT_1d_firstlead_ffnn_typ2_randomseed/` — per-seed logs (`*_seed40.txt` … `*_seed44.txt`), learning curves, confusion matrix, ROC/PR plots, and a `*_multiseed_summary.csv`

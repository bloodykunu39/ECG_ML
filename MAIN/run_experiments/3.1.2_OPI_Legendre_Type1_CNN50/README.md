...
Robustness check: SmallCNN on more aggressively downsampled 50x50 Legendre OPI images, Data Type 1.

## Contents

- `main_2d_leg_on_50_typ1.ipynb`

- `EXPERIMENT_2d_leg_50_typ1_smallcnn_randomseed/` — per-seed logs (`*_seed40.txt` … `*_seed44.txt`), learning curves, confusion matrix, ROC/PR plots, and a `*_multiseed_summary.csv`

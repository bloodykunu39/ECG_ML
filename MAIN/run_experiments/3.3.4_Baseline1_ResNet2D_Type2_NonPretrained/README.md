# Baseline 1: 2D ECGResNet (randomly initialized), Data Type 2

**Paper section:** 3.3.4 (see `../../../draft.pdf`)

Non-pretrained variant, Data Type 2.

## Contents

- `main_2d_resnet_typ2_pretrained_False.ipynb`

- `EXPERIMENT_2d_resnet_typ2_ECGresnet_pretrain_FALSE_randomseed/` — per-seed logs (`*_seed40.txt` … `*_seed44.txt`), learning curves, confusion matrix, ROC/PR plots, and a `*_multiseed_summary.csv`

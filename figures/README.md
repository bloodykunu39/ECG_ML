...
│   └── small_cnn_alexnet_format.png        # Small CNN model (AlexNet-style layout)
├── Signal Processing Visualizations
│   ├── image_1D_multiple_signals.png       # Multiple 1D signal visualization
│   ├── 2dimage.png                         # 2D image representation example
│   └── new_fig.png                         # Additional visualization figure
└── README.md
```
...
These supplementary materials provide visual aids and figure generation scripts for papers, presentations, and project documentation. The images illustrate key concepts such as ECG signal structure, encoding methods, and model architectures.

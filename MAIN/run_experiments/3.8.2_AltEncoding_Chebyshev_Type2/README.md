# Alternative encoding: Chebyshev-CNN, Data Type 2

**Paper section:** 3.8.2 (see `../../../draft.pdf`)

Chebyshev-encoded CNN, Data Type 2.

## Contents

- `main_2d_cheb_typ2.ipynb`

- `EXPERIMENT_2d_cheb_typ2_smallcnn_randomseed/` — per-seed logs (`*_seed40.txt` … `*_seed44.txt`), learning curves, confusion matrix, ROC/PR plots, and a `*_multiseed_summary.csv`

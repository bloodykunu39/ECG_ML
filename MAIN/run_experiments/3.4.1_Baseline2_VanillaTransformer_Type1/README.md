# Baseline 2: Vanilla Transformer, Data Type 1

**Paper section:** 3.4.1 (see `../../../draft.pdf`)

High-capacity sequence model (VanillaTransformerECG) trained on the raw 12-lead ECG signals, Data Type 1.

## Contents

- `main_1_transformer_typ1.ipynb`

- `EXPERIMENT_2d_transformer_typ1_VanillaTransformerECG_randomseed/` — per-seed logs (`*_seed40.txt` … `*_seed44.txt`), learning curves, confusion matrix, ROC/PR plots, and a `*_multiseed_summary.csv`

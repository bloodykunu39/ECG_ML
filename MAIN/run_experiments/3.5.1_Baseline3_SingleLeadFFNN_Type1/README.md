# Baseline 3: Single-lead FFNN (Lead 1), Data Type 1

**Paper section:** 3.5.1 (see `../../../draft.pdf`)

Feed-forward neural network on raw Lead-1 signal only, no polynomial encoding, Data Type 1.

## Contents

- `main_1_ffnn_singlelead_typ1.ipynb`

- `EXPERIMENT_1d_firstlead_ffnn_typ1_randomseed/` — per-seed logs (`*_seed40.txt` … `*_seed44.txt`), learning curves, confusion matrix, ROC/PR plots, and a `*_multiseed_summary.csv`
